...
python manage.py lms --settings=derex_django.settings.build.assets compilemessages -v2
python manage.py cms --settings=derex_django.settings.build.assets compilemessages -v2

python manage.py lms --settings=derex_django.settings.build.assets compilejsi18n -v2
python manage.py cms --settings=derex_django.settings.build.assets compilejsi18n -v2
