...
class CoursewareSearchIndexer(SearchIndexerBase):
    ...
    """
    if os.environ["ELASTICSEARCH_PREFIX"]:
        INDEX_NAME = os.environ["ELASTICSEARCH_PREFIX"] + "_" + "courseware_content"
    else:
...
class LibrarySearchIndexer(SearchIndexerBase):
    ...
    """
    if os.environ["ELASTICSEARCH_PREFIX"]:
        INDEX_NAME = os.environ["ELASTICSEARCH_PREFIX"] + "_" + "library_index"
    else:
...
class CourseAboutSearchIndexer(CoursewareSearchIndexer):
    ...
    """
    if os.environ["ELASTICSEARCH_PREFIX"]:
        INDEX_NAME = os.environ["ELASTICSEARCH_PREFIX"] + "_" + "course_info"
    else:
